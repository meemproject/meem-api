...
import type { Meem, MeemInterface } from "../Meem";
...
export class Meem__factory {
  ...
  static createInterface(): MeemInterface {
    return new utils.Interface(_abi) as MeemInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Meem {
    return new Contract(address, _abi, signerOrProvider) as Meem;
  }
}
