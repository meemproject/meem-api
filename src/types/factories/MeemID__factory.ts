...
import type { MeemID, MeemIDInterface } from "../MeemID";
...
const _abi = [
  ...
  },
  {
    ...
    name: "removeWalletAddressByWalletAddress",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class MeemID__factory {
  static readonly abi = _abi;
  static createInterface(): MeemIDInterface {
    return new utils.Interface(_abi) as MeemIDInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MeemID {
    return new Contract(address, _abi, signerOrProvider) as MeemID;
  }
}
