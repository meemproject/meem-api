...
export default {
	...
	LAMBDA_BULK_MINT_FUNCTION_NAME:
		process.env.LAMBDA_BULK_MINT_FUNCTION_NAME ?? '',
	...
	ARBITRUM_GAS_MULTIPLIER: process.env.ARBITRUM_GAS_MULTIPLIER
		...
		: 6,
	JSON_RPC_GOERLI: process.env.JSON_RPC_GOERLI ?? '',
	JSON_RPC_MUMBAI: process.env.JSON_RPC_MUMBAI ?? '',
	JSON_RPC_ARBITRUM_GOERLI: process.env.JSON_RPC_ARBITRUM_GOERLI ?? '',
	JSON_RPC_OPTIMISM_GOERLI: process.env.JSON_RPC_OPTIMISM_GOERLI ?? ''
}
